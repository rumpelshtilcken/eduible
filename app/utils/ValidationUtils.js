...
const ValidationUtils = {
  isValidEmail: candidate =>/^([A-Za-z0-9]{1,})(([.]|[-]|[_]){1}[A-Za-z0-9]+){1,}[@]{1}([A-z0-9]+)([.][A-z0-9]+)+$/.test(candidate),
  ...
  isValidName: candidate => /^[A-Z](('[A-Z][a-z]+)|([a-z]+)|(.[ ][A-Z][a-z]+))(-[A-Z][a-z]+)?([ ][A-Z][.])?([ ][A-Z][a-z]+)((-[A-Z][a-z]+)?)$/.test(candidate)
};
